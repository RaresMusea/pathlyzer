...
import { availableLanguages } from "../../course-editor/serialization/CourseContentSerializer";
import { CodeLightbox } from "./CodeLightbox";
...
export const CodeBlock = ({ code, language, html }: ICodeBlock) => {
    ...
    return (
        <>
            ...
            <CodeLightbox copyToClipboard={copyToClipboard}
                toggleFullscreen={toggleFullscreen}
                handleThemeChange={handleThemeChange}
                isFullscreen={isFullscreen}
                isAnimating={isAnimating}
                copied={copied}
                darkModeOverlayClasses={darkModeOverlayClasses}
                darkModeClasses={darkModeClasses}
                darkModeHeaderClasses={darkModeHeaderClasses}
                darkModeLineNumbersClasses={darkModeLineNumbersClasses}
                darkModeFooterClasses={darkModeFooterClasses}
