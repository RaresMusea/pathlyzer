...
export function TabsDemo() {
  const tabs = [
    {
      ...
      value: "python",
      content: (
        <div className="w-50 scrollbar-hide overflow-hidden overflow-x-hidden relative h-[35rem] rounded-2xl p-2 shadow-md text-xl md:text-4xl font-bold text-white bg-[#1D63ED] dark:bg-[#00084D]">
    ...
    },
    {
      ...
      value: "java",
      content: (
        <div className="w-50 scrollbar-hide overflow-hidden relative h-[35rem] rounded-2xl p-2 shadow-md text-xl md:text-4xl font-bold text-white bg-[#1D63ED] dark:bg-[#00084D]">
  ...
  return (
    <div className="h-[40rem] md:h-[40rem] [perspective:1000px] relative b flex flex-col max-w-3xl mx-auto w-full items-center justify-start my-20">
      <Tabs tabs={tabs} />
    </div>
  );
}