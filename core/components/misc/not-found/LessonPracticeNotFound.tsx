...
export const LessonPracticeNotFound = ({ backText, backUrl }: { backText: string, backUrl: string }) => {
    ...
    return (
        ...
        >
            ...
            >
                Sorry, we couldn&apos;t find the requested lesson practice.
