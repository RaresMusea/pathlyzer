...
export const QuizNotFound = ({ backText, backUrl }: { backText: string, backUrl: string }) => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <ListChecks className="w-16 h-16 mx-auto mb-2" />
                </motion.div>
                <motion.div
            ...
            >
                Sorry, we couldn&apos;t find the requested quiz.
