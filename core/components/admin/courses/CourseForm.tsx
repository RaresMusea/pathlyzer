...
import { ErrorHandlerGeneric } from "@/components/misc/errors/ErrorHandlerGeneric";

export const CourseForm = ({ course, tags }: { course?: CourseDto, tags: CourseTag[] }) => {
    const { form, onSubmit, errors, router, imagePreview, removeImage, handleImageUpload, isPending } = useCourseMutator(tags, course);
